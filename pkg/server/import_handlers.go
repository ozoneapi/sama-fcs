...
// `bitbucket.org/ozoneapi/sama-conformance-suite/pkg/server/models.ImportReviewResponse` or
//  `bitbucket.org/ozoneapi/sama-conformance-suite/pkg/server/models.ImportRerunResponse` and do not do the
