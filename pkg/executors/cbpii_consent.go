...
func getCbpiiConsents(
	...
	requiredTokens []testlist.RequiredTokens,
	ctx *model.Context,
) (ConsentTokens, error) {
	executor := &Executor{}
...
func runCbpiiConsents(rt []testlist.RequiredTokens, ctx *model.Context, executor *Executor) ([]testlist.RequiredTokens, error) {
