...
// ConsentTokens captures the token/consentIds awaiting authorisation
type ConsentTokens []ConsentToken

// ConsentToken is a single consentId mapping to token name
...
// NewTokenCollector -
func NewTokenCollector(log *logrus.Entry, consentIds ConsentTokens, doneFunc func(), events events.Events) TokenCollector {
...
func (c *tokenCollector) Tokens() ConsentTokens {
	logger := c.log.WithFields(logrus.Fields{
		"module":   "tokenCollector",
		"function": "Tokens",
	})
