<template>
  <div class="d-flex flex-column align-items-stretch h-600 navbar">
    <div class="nav-section px-1 mb-5">
      <b-nav vertical pills>
        <TheNavBarItem :no="1" route="/wizard/continue-or-start" label="Start/Load Test" />
        <TheNavBarItem :no="2" route="/wizard/discovery-config" label="Discovery" exact />
        <TheNavBarItem :no="3" route="/wizard/configuration" label="Configuration" />
        <TheNavBarItem :no="4" route="/wizard/overview-run" label="Run/Overview" />
        <TheNavBarItem :no="5" route="/wizard/export" label="Export" />
      </b-nav>
    </div>
    ...
    <div class="nav-section tools flex-fill">
      ...
      <b-nav vertical class="mb-2">
        <b-nav-item href="https://openbanking.sa" target="_blank">
        ...
        <b-nav-item >        
          {{ suiteVersion }}<br>Powered by<br>
          <img width="180" height="56" src="/img/ozoneapi.png"/>          
        </b-nav-item>
      </b-nav>
    </div>
    <br />
